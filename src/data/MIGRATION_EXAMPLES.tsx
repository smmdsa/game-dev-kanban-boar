...
// ===========================================
// Este archivo muestra cómo migrar de useKV directo
// a usar los hooks del DataContext
...
function TaskList() {
  ...
  // Refresh manual (raro - auto-refresh incluido)
...
const mockProvider: DataProvider = {
  ...
  tasks: {
    ...
    deleteTask: async () => ({ data: null, error: null }),
